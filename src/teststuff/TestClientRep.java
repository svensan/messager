...
public class TestClientRep {

    private TestComm connection;
    private SAXParserFactory saxFactory = SAXParserFactory.newInstance();
    private SAXParser parser;

    public TestClientRep(Socket connection, TestMessageReceiver messager) throws Exception {
        this.connection = new TestComm(connection, this);
